...
/datum/appearance_debugger/proc/get_readable_layers()
	return list(
		...
		"MOB_UNDIES_TOP_LAYER1" = MOB_UNDIES_TOP_LAYER1,
		"MOB_UNDIES_TOP_LAYER2" = MOB_UNDIES_TOP_LAYER2,
		"MOB_UNDIES_BOTTOM_LAYER" = MOB_UNDIES_BOTTOM_LAYER,
		"MOB_UNDIES_FEET_LAYER1" = MOB_UNDIES_FEET_LAYER1,
		"MOB_UNDIES_FEET_LAYER2" = MOB_UNDIES_FEET_LAYER2,

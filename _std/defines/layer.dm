...
#define MOB_UNDIES_TOP_DETAIL (MOB_OVERLAY_BASE-16)
#define MOB_UNDIES_TOP		(MOB_OVERLAY_BASE-16.1)
#define MOB_UNDIES_BOTTOM	(MOB_OVERLAY_BASE-16.2)
#define MOB_UNDIES_FEET_DETAIL (MOB_OVERLAY_BASE-16.3)
#define MOB_UNDIES_FEET		(MOB_OVERLAY_BASE-16.4)

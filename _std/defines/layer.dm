...
#define UNDERFLOOR_MACHINE	(TURF_LAYER+0.5)
...
#define MOB_UNDIES_TOP_LAYER1 (MOB_OVERLAY_BASE-16)
#define MOB_UNDIES_TOP_LAYER2 (MOB_OVERLAY_BASE-16.1)
#define MOB_UNDIES_BOTTOM_LAYER	(MOB_OVERLAY_BASE-16.2)
#define MOB_UNDIES_FEET_LAYER1 (MOB_OVERLAY_BASE-16.3)
#define MOB_UNDIES_FEET_LAYER2 (MOB_OVERLAY_BASE-16.4)
